...
const APP_NAME = "Resize Images Online Free — Instagram, YouTube, X Presets | Fit";
  ...
  head: () => ({
    meta: [
      ...
      { name: "google-adsense-account", content: "ca-pub-7636435144500691" },
      {
        name: "keywords",
        content:
          "resize image online free, instagram image size, youtube thumbnail size, twitter header size, crop to pixels, image resizer no upload",
      },
    ],
    links: [
